	...
	<div id="main-wrapper">
            ...
            <div class="deznav-scroll">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Trang Quản Lý</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="QLSP.php?page=quanlysanpham">Trang Quản lý sản phẩm</a></li>
                            <li><a href="QLKH.php?page=quanlykhachhang">Trang Quản lý Khách Hàng</a></li>
                            <li><a href="QLNV.php?page=quanlynhanvien">Trang Quản lý Nhân Viên</a></li>
						</ul>
        ...
        ***********************************-->
		...
		<!--**********************************
            Content body start
        ***********************************-->
		<div class="content-body" style="margin-left:8px; margin-right: 8px">

			<div class="row">
				<div class="col-6 col-sm-3 text-center">
					<div class="card">
						<img class="card-img-top" src="./images/iphone13.jpg" alt="Title" />
						<div class="card-body">
							<h4 class="card-title">tên sản phẩm</h4>
							<p class="card-text">Tên loại sản phẩm</p>
							<h5 class="card-text"></h5>Đơn vị tính</h5>
							<h6 class="text-danger card-text">giá</h6>
							<p class="text-center card-text">Số lượng</p>
							<button (click)="addToCart(item)" class="btn btn-sm btn-primary card-text">Add to Cart</button>
						</div>
					</div>
				</div>
				<div class="col-6 col-sm-3 text-center">
