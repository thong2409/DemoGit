...
<body>
        ...
        <div class="container text-center pt-5 pb-3">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-primary active" aria-current="page">Tìm kiếm</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class=" bg-light my-6 py-6 pt-0" style="margin: 12rem 0;">
        <div class="container">
            ...
            // Viết truy vấn SQL để tìm kiếm sản phẩm theo tên đã vào ô search
            function timKiemSanPham($tenSanPham) {
                // Khởi tạo đối tượng database
                $db = new Database();

                // Tạo truy vấn SQL tìm kiếm sản phẩm theo tên
                $sql = "SELECT * FROM sanpham WHERE TenSP LIKE '%$tenSanPham%'";

                // Thực thi truy vấn và lưu kết quả vào biến $result
                $result = $db->query($sql);

                // Tạo mảng để lưu trữ sản phẩm tìm kiếm
                $sanPhamTimKiem = [];

                // Duyệt qua kết quả truy vấn
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        $sanPhamTimKiem[] = $row; // Thêm sản phẩm vào mảng
                    }
                }
                ...
                // Trả về mảng sản phẩm tìm kiếm
                return $sanPhamTimKiem;
            }
            $searchTerm = $_GET['search_term'];
            $prodSearch = timKiemSanPham($searchTerm);

            ?>
                <div class="row g-4">
                    <?php if(!empty($prodSearch)):; ?>
                    <?php foreach($prodSearch as $product):;?>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <img class="img-fluid bg-light rounded p-1" src="./images/Bánh mì 5.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light rounded p-1" src="./images/Bánh mì 6.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light rounded p-1" src="./images/Bánh mì 1.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light rounded p-1" src="./images/Bánh mì 2.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light rounded p-1" src="./images/Bánh mì 3.jpg" alt="Image">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light rounded p-1" src="./images/Bánh mì 4.jpg" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
